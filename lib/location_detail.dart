...
class _LocationDetailState extends State<LocationDetail> {
  ...
  // in a constructor, when using this. it will automatically bind the value
  // that you pass in to that member
  ...
  loadData() async {
    ...
    // setState only when a widget is mounted, really important
    if (mounted) {
      setState(() {
...
//  a Container is like a div in web development
  Widget _sectionTitle(String text) {
    return Container(
      padding: EdgeInsets.fromLTRB(Styles.horizontalPaddingDefault, 25,
          Styles.horizontalPaddingDefault, 0),
      child: Text(
        text.toUpperCase(),
