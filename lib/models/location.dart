import 'dart:async';
import 'dart:convert';
import 'package:fluttercrashcourse_lesson12/endpoint.dart';
...
class Location {
  ...
  // a List is effectively an Array, you define the type of each member of
  // the list
  ...
  // gives default values, cant do it in above declaration because they final
  Location.blank()
      : id = 0,
        name = '',
        url = '',
