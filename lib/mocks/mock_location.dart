...
// extends means: MockLocation is going to take on all the properties of Location
class MockLocation extends Location {
  //  static: don't need to create an instance of a class once I define it
  // final: I don't want to change it once I define it
